...
void MadgwickAHRSupdate(float gx, float gy, float gz,
    ...
    if (!((ax == 0.0f) && (ay == 0.0f) && (az == 0.0f))) {
        ...
        hx = mx * q0q0 - _2q0my * q[3] + _2q0mz * q[2] + mx * q1q1 + _2q1 * my * q[2]
                + _2q1 * mz * q[3] - mx * q2q2 - mx * q3q3;
        hy = _2q0mx * q[3] + my * q0q0 - _2q0mz * q[1] + _2q1mx * q[2] - my * q1q1
                + my * q2q2 + _2q2 * mz * q[3] - my * q3q3;
        _2bx = sqrt(hx * hx + hy * hy);
        _2bz = -_2q0mx * q[2] + _2q0my * q[1] + mz * q0q0 + _2q1mx * q[3] - mz * q1q1
        ...
        s1 = _2q3 * (2.0f * q1q3 - _2q0q2 - ax)
                ...
                - 4.0f * q[1] * (1 - 2.0f * q1q1 - 2.0f * q2q2 - az)
                + _2bz * q[3]
                        * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2)
                                - mx)
                + (_2bx * q[2] + _2bz * q[0])
        ...
        s2 = -_2q0 * (2.0f * q1q3 - _2q0q2 - ax)
                ...
                - 4.0f * q[2] * (1 - 2.0f * q1q1 - 2.0f * q2q2 - az)
                + (-_4bx * q[2] - _2bz * q[0])
                        * (_2bx * (0.5f - q2q2 - q3q3) + _2bz * (q1q3 - q0q2)
                                - mx)
                + (_2bx * q[1] + _2bz * q[3])
